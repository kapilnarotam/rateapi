...
Rate.create(market_id: 1 , price: 230.0)
Rate.create(market_id: 2 , price: 170.0)
Rate.create(market_id: 3 , price: 20.0)
Rate.create(market_id: 4 , price: 445.0)
Rate.create(market_id: 5 , price: 143.1)
Rate.create(market_id: 6 , price: 0.2)
Rate.create(market_id: 7 , price: 0.25)