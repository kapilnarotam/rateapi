...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post markets_url, params: { market: { base_currency_id: @market.base_currency_id, quoted_currency_id: @market.quoted_currency_id } }, as: :json
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { base_currency_id: @market.base_currency_id, quoted_currency_id: @market.quoted_currency_id } }, as: :json
    assert_response 200
  end
